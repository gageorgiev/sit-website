...
export default function Preslav(props) {
            ...
            <div className="flex flex-wrap mt-10 mb-20">
                <div className="w-full flex flex-col items-start">
                    <div className="w-3/4 font-hairline">
                        <h1 className="text-4xl md:text-5xl text-red-600 font-medium">ПРЕСЛАВ</h1>
                    </div>
                    <div className="flex flex-col md:flex-row justify-around w-full">
                        ...
                        <div className="h-96 w-full md:w-2/3">
                            ...
                            >
                                <Slider>
                                    <Slide index={0} >
                                        <Image src={require('../../images/project-images/preslav/dsc_0018.jpg')} />
                                    </Slide>
                                </Slider>
                                <div className="flex flex-row justify-center">
                                    <Dot slide={0}>
                                        <img src={require('../../images/project-images/preslav/dsc_0018.jpg')} className="h-16 p-1" />
                                    </Dot>
                                </div>
                            </CarouselProvider>
                        </div>
